...
class FollowRequestsTests: XCTestCase {
    func testAll() {
        let request = MastodonRequests.FollowRequests.All()
    ...
    func testAllWithRange() {
        let request = MastodonRequests.FollowRequests.All(range: .max(id: "12", limit: 50))
    ...
    func testAuthorize() {
        let request = MastodonRequests.FollowRequests.Authorize(id: "42")
    ...
    func testReject() {
        let request = MastodonRequests.FollowRequests.Reject(id: "42")
